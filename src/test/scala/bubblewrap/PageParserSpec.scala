...
class PageParserSpec extends FlatSpec {
  "PageParser" should "parse absolute url from meta refresh" in {
    ...
    PageParser().parse(Content(WebUrl("http://www.example.com"), html)).metaRefresh should be(Some(WebUrl("http://www.example.com/refresh")))
  }
  ...
  it should "parse none from meta refresh if meta not present" in {
    ...
    PageParser().parse(Content(WebUrl("http://www.example.com"), html)).metaRefresh should be(None)
  }
  ...
  it should "parse absolute url from rel canonical" in {
    ...
    PageParser().parse(Content(WebUrl("http://www.example.com"), html)).canonicalUrl should be(Some(WebUrl("http://www.example.com/canonical")))
  }
  ...
  it should "parse none from rel canonical if link not present" in {
    val html = """<html><body>Hi</body></html>"""
    PageParser().parse(Content(WebUrl("http://www.example.com"), html)).canonicalUrl should be(None)
  }
  ...
  it should "extract outgoing links from a and link tags" in {
    ...
    PageParser().parse(Content(WebUrl("http://www.example.com"), html)).outgoingLinks should contain(WebUrl("http://www.example.com/link"))
    PageParser().parse(Content(WebUrl("http://www.example.com"), html)).outgoingLinks should contain(WebUrl("http://www.example.com/a"))
  }
  ...
  it should "extract outgoing links from a and link tags ignoring nofollow and canonical" in {
    ...
    PageParser().parse(Content(WebUrl("http://www.example.com"), html)).outgoingLinks should be(List.empty)
  }
